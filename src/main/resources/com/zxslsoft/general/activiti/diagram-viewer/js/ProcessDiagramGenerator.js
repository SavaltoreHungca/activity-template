...
var ProcessDiagramGenerator = {	
	...
	_drawDiagram: function() {
		...
		// Check if process is already loaded and rendered
	...
	_generateDiagram: function() {
		...
		//console.log("process-definition-diagram-layout["+processDefinitionDiagramLayout.process.id+"]: ", processDefinitionDiagramLayout);
	...
	getProcessDefinitionByKey: function(processDefinitionKey) {
		...
		if (processDefinition) {
			//console.log("Get process definition by key '" + processDefinitionKey + "': ", process.id);
